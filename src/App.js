        ...
        <div className="bg-white border px-[40px] pt-10 pb-2">
          ...
          <form className="grid gap-y-1.5">
            ...
            <button
              type="submit"
              disabled={!enable}
              className="h-[30px] mt-1 rounded bg-brand fond-medium text-white text-sm disabled:opacity-50"
            >
              Log In
            </button>
            ...
            <a
              href=""
              className="text-xs flex items-center justify-center font-semibold text-link"
            >
              Forgot password?
            </a>
          </form>
