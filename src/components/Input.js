  ...
  useEffect(()=>{
    ...
    return(
        ...
        ref={inputRef}
          ...
          {...props}
        />
        <small className="absolute top-1/2 left-[9px] cursor-text pointer-events-none text-ts text-gray-400 -translate-y-1/2 transition-all peer-valid:text-[10px] peer-valid:top-2">
          {label}
        </small>
